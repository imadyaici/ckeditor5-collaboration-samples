...
1. Clone the repository:
   ...
   cd ckeditor5-collaboration-samples/comments-outside-of-editor-for-react
   ```

2. Open the `samples/comments-outside-of-editor-for-react.html` page in the browser.
